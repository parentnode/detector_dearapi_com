...
if($page->getStatus("list")) {
	...
	$page->setUrlMarker();
	$page->getTemplate("html.list.php", $object, "c300 border", "container:item");
}
...
else if($page->getStatus() == "clone") {

	// attempt to save
//	$id = $page->getObject($object)->saveItem();
	$id = $page->getObject($object)->cloneDevice(getVar("id"), false);
