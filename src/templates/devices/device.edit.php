...
?>
	...
	<div class="c">
		...
		<div class="ci50">
			<fieldset>
				<?= $this->select($this->varnames["brand_id"], "brand_id", Page::getItems(UT_BAS_BRA), $this->vars["brand_id"], array("", "-")) ?>
			</fieldset>
		</div>
	</div>
	...
	<div class="c init:expandable id:contenttypes">
		...
		<?= $this->p("browser/?, display/?, pointing/?, released/?, system/? [, segment/ - only if devices mismatches browser segment]") ?>
		<fieldset>
			<?
	...
	<div class="c useragents init:expandable id:useragents">
		...
		<fieldset>
			...
			<?
				...
				$table->setHeader(0, $this->varnames["useragent"]." (".count($column).")", "max");
